...
import { AnnotationProps, StageProps, modelInputProps } from "./helpers/Interfaces";
...
const Stage = ({
  ...
  const HOMEPAGE_IMAGE = "/assets/gallery/1.jpg";
  ...
  useEffect(() => {
    if (isStandalone && model) {
      const url = new URL(HOMEPAGE_IMAGE, path);
